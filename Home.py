...
st.write("""**🧮 Total de Campos:** Tenha um controle completo sobre seus índices e documentos, acompanhando o número de campos em tempo real. Uma visão abrangente para melhorar sua estratégia de indexação.
